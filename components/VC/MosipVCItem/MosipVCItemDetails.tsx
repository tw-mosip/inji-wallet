...
> = props => {
  ...
  const isPendingVerification = props.vc?.vcMetadata?.isPendingVerification;

  const vcStatus = isPendingVerification ? t('pending') : t('valid');
  ...
  return (
    <Column margin="10 4 10 4">
      ...
      {!isPendingVerification && props.activeTab !== 1 ? (
