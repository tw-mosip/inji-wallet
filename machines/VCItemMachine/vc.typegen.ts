  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "done.invoke.vc.tamperedVCs.triggerAutoBackupForTamperedVcDeletion:invocation[0]": { type: "done.invoke.vc.tamperedVCs.triggerAutoBackupForTamperedVcDeletion:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"loadMyVcs": "DOWNLOAD_LIMIT_EXPIRED" | "REFRESH_MY_VCS" | "REFRESH_VCS_METADATA" | "STORE_RESPONSE" | "VERIFY_VC_FAILED" | "xstate.init";
...
"updateMyVcs": "VC_METADATA_UPDATED";
        ...
        matchesStates: "deletingFailedVcs" | "init" | "init.myVcs" | "init.receivedVcs" | "ready" | "ready.myVcs" | "ready.myVcs.idle" | "ready.myVcs.refreshing" | "ready.receivedVcs" | "ready.receivedVcs.idle" | "ready.receivedVcs.refreshing" | "tamperedVCs" | "tamperedVCs.refreshVcsMetadata" | "tamperedVCs.triggerAutoBackupForTamperedVcDeletion" | { "init"?: "myVcs" | "receivedVcs";
"ready"?: "myVcs" | "receivedVcs" | { "myVcs"?: "idle" | "refreshing";
"receivedVcs"?: "idle" | "refreshing"; };
"tamperedVCs"?: "refreshVcsMetadata" | "triggerAutoBackupForTamperedVcDeletion"; };
        tags: never;
      }
