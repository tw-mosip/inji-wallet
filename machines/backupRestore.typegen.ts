...
export interface Typegen0 {
    ...
    internalEvents: {
        ...
        "done.invoke.backupRestore.restoreBackup.checkStorageAvailibility:invocation[0]": { type: "done.invoke.backupRestore.restoreBackup.checkStorageAvailibility:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
    ...
    eventsCausingActions: {
        ...
        "sendDataRestoreFailureEvent": "STORE_ERROR" | "done.invoke.backupRestore.restoreBackup.checkStorageAvailibility:invocation[0]" | "error.platform.backupRestore.restoreBackup.downloadBackupFileFromCloud:invocation[0]" | "error.platform.backupRestore.restoreBackup.unzipBackupFile:invocation[0]";
        ...
        "setRestoreTechnicalError": "STORE_ERROR" | "done.invoke.backupRestore.restoreBackup.checkStorageAvailibility:invocation[0]";
    };
    eventsCausingDelays: {
    ...
    eventsCausingGuards: {
        ...
        "isZIPfile": "done.invoke.backupRestore.preload:invocation[0]";
    };
    eventsCausingServices: {
        ...
        "unzipBackupFile": "done.invoke.backupRestore.preload:invocation[0]" | "done.invoke.backupRestore.restoreBackup.downloadBackupFileFromCloud:invocation[0]";
    };
    matchesStates: "init" | "preload" | "restoreBackup" | "restoreBackup.checkStorageAvailibility" | "restoreBackup.deleteBackupDir" | "restoreBackup.downloadBackupFileFromCloud" | "restoreBackup.failure" | "restoreBackup.idle" | "restoreBackup.loadDataToMemory" | "restoreBackup.readBackupFile" | "restoreBackup.success" | "restoreBackup.unzipBackupFile" | { "restoreBackup"?: "checkStorageAvailibility" | "deleteBackupDir" | "downloadBackupFileFromCloud" | "failure" | "idle" | "loadDataToMemory" | "readBackupFile" | "success" | "unzipBackupFile"; };
    tags: never;
}
