...
import {BackupRestoreGuards} from './BackupRestoreGuards';
import {BackupRestoreServices} from './BackupRestoreServices';
import {BackupRestoreActions} from './BackupRestoreActions';
...
export const backupRestoreMachine = model.createMachine(
  {
    ...
    tsTypes: {} as import('./BackupRestoreMachine.typegen').Typegen0,
    schema: {
  ...
  {
    actions: BackupRestoreActions(model),

    services: BackupRestoreServices(model),

    guards: BackupRestoreGuards(),
  },
);
