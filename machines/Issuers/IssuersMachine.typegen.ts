...
export interface Typegen0 {
  ...
  eventsCausingActions: {
    ...
    getKeyPairFromStore: 'FACE_AUTH_SUCCESS' | 'TRY_AGAIN';
    ...
    setLoadingReasonAsDownloadingCredentials:
      ...
      | 'TRY_AGAIN'
      | 'done.invoke.issuersMachine.generateKeyPair:invocation[0]';
    setLoadingReasonAsFaceAuth: 'done.invoke.issuersMachine.performAuthorization:invocation[0]';
    setLoadingReasonAsSettingUp:
      | 'FACE_AUTH_SUCCESS'
      | 'SELECTED_ISSUER'
      | 'TRY_AGAIN';
  ...
  matchesStates:
    ...
    | 'performAuthorization.performFaceAuthAndRedirection'
